...
<div class="wrapper">
                  ...
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="delete-company.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this company?');">Delete</a></td>
                      </tr>  
                     <?php $k++;
                        }
                      }
  ...
  <div class="text-center">
      <strong>Copyright &copy; 2022. PROSTAFF</strong> All rights
