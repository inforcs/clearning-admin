              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      <?php
                       $sql = "SELECT * FROM candidate_apply INNER JOIN courses ON candidate_apply.course_id=courses.courseid order by candidate_apply.id desc";
                      ...
                      <tr>                        
                        ...
                        <td><a href="delete-application.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this Application?');">Delete</a></td>
                      </tr>
