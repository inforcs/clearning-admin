      ...
      <div class="container">
        <div class="row">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  <li class="active"><a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
				          <li><a href="create-course.php"><i class="fa fa-edit"></i> Create New course</a></li>
                  ...
                  <li><a href="tutor.php"><i class="fa fa-building"></i> Tutor Enquiry</a></li>
            ...
            <div class="row">
              ...
              <?php
                      ...
                      if($result->num_rows > 0) {
                        ...
                        $new_row = $row['courseid'];
                        
                      ?>
							<label for="input-7">Course ID</label>
							  <div class="form-group">
								<input class="form-control input-lg" type="text" id="courseid" name="courseid" value="<?php echo $new_row+1 ?>" readonly>
							  </div> <?php } ?>
						</div>
						<div class="col-md-6">
							<label for="input-7">Course Name</label>
							  <div class="form-group">
								<input class="form-control input-lg" type="text" id="coursetitle" name="coursetitle" placeholder="coursetitle" required>
							  </div>
						</div>
					</div>
						...
						<div class="col-md-6"> 
						   ...
						   <div class="form-group">
							<input class="form-control input-lg" type="text" id="contactperson" name="contactperson" placeholder="Write Name of Person" required>
						  </div>
						</div>
					</div>
          ...
          <!-- <div class="row">
            ...
            <div class="col-md-6"> 
              <label for="input-7">Course fees</label>
               <div class="form-group">
              <input class="form-control input-lg" type="text" id="price" name="price" placeholder="Fees" required>
              </div>
            </div>
          </div>
					...
					<div class="row">
						...
						<div class="col-md-6"> 
							 <div class="form-group">
								...
								<select class="form-control" name="coursestatus" id="coursestatus" required>
				 ...
				 <div class="form-group">
                    <textarea class="form-control input-lg" id="youtube" name="youtube" placeholder="youtube" required></textarea>
                  </div>
				   <label for="input-7">Description</label>
				 <div class="form-group">
                    <textarea class="form-control input-lg" id="summernoteEditor" name="coursedesc" placeholder="course description" required></textarea>
                  </div>
