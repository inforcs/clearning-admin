                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td  class="text-center">
                          <a href="edit-courses.php?id=<?php echo $row['id_coursepost']; ?>"><i class="fa fa-edit"></i></a> &nbsp; &nbsp; &nbsp;
                          <a href="view-courses.php?id=<?php echo $row['id_coursepost']; ?>"><i class="fa fa-address-card-o"></i></a> &nbsp; &nbsp; &nbsp;
                          <a href="delete-course.php?id=<?php echo $row['id_coursepost']; ?>" onclick="return confirm('Are you sure you want to delete this Job?');"><i class="fa fa-trash"></i></a></td>
                      </tr>  
                            <?php
                        }
                      }
